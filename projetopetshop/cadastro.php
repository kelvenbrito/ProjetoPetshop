...
<body>
  ...
  <form class="needs-validation1" novalidate action="cadastroprocesso.php" method="post" onsubmit="enviar()">
    <h1>CADASTRE-SE</h1>
    <div class="form-row mb-4">
      <div class="col-md-4 mb-3">
        <label for="pNome">Primeiro nome</label>
        <input type="text" class="form-control" id="pNome" name="pNome" pattern="[A-Za-z]+" required>
